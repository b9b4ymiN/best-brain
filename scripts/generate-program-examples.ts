...
const runtimeBundle: RuntimeSessionBundle = {
  ...
  worker_tasks: [
    {
      ...
      artifact_refs: ['example://worker-analysis-note', 'example://worker-analysis-json'],
      check_names: ['analysis-grounded'],
      retry_recommendation: null,
      invocation_command: 'claude',
      invocation_args: ['-p', '--output-format', 'json', '[prompt]'],
    ...
    },
    {
      ...
      invocation_args: ['playbook_thai_equities_daily', 'task_verification'],
      verifier_owned: true,
  ...
  events: [
    ...
    {
      id: 'event_runtime_finalized',
      session_id: 'session_program_example',
      mission_id: workerTaskInput.mission_id,
      task_id: null,
      event_type: 'runtime_session_finalized',
      actor: 'runtime',
      detail: 'Runtime session finalized after verification status verified_complete.',
      data: {
