  ...
  phase_timeline: [
    {
      ...
      ended_at: now + 2_000,
      duration_ms: 2_000,
      detail: 'Mission goal was captured and runtime session started.',
    },
    {
      phase: 'consult',
      title: 'Brain Consult',
      ...
      ended_at: now + 3_000,
      duration_ms: 3_000,
      detail: 'Persona and memory context were loaded for planning.',
    },
    {
      phase: 'compile',
      title: 'Mission Compile',
      status: 'completed',
      started_at: now + 3_000,
      ended_at: now + 4_000,
      duration_ms: 1_000,
      detail: 'Mission brief, task graph, and adapter decisions were compiled.',
    },
    {
      phase: 'dispatch',
      ...
      ended_at: now + 5_000,
      duration_ms: 1_000,
      detail: 'Primary worker dispatch completed.',
    },
    {
      phase: 'execute',
      title: 'Execution',
      ...
      ended_at: now + 20_000,
      duration_ms: 15_000,
      detail: 'Workers executed task graph nodes and produced artifacts.',
    },
    {
      phase: 'verify',
      title: 'Verification Gate',
      status: 'completed',
      started_at: now + 21_000,
      ended_at: now + 25_000,
      duration_ms: 4_000,
      detail: 'Verifier accepted checks and evidence.',
    },
    {
      phase: 'report',
      title: 'Final Report',
      ...
      ended_at: now + 26_000,
      duration_ms: 0,
      detail: 'Manager emitted the final owner-facing report artifact.',
    },
  ],
  timeline: [
    {
  ...
  workers: [
    {
      ...
      artifact_count: 2,
      last_summary: 'Implemented report contract and produced file + note evidence.',
    ...
    },
    {
      ...
      current_task_title: null,
      artifact_count: 2,
      last_summary: 'Verifier confirmed checklist and proof chain.',
