...
export function buildExecutionRequest(brief: MissionBrief, cwd: string): ExecutionRequest | null {
  ...
  return {
    ...
    prompt: [
      ...
      'Only emit passed=false proposed_checks for objective blockers or playbook-required proof failures. Advisory caveats and future confirmations belong in summary or risks, not as failed checks.',
